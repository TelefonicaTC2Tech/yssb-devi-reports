...
from reports.utils import  convert_to_datetime, get_request_type, get_value 
from soar.soar_report import send_soar_report

TES_SYSTEM = "TES"
PRODUCT_TIER3 = "S170_Empresa Segura"
SUBSCRIPTION_TYPE = "Paquete TES Lite"
...
FIELDS = Fields((
    ...
    Field('Subscription', lambda r: SUBSCRIPTION_TYPE),
