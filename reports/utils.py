...
CYBERSEC_SUBSCRIPTION = "Ciberseguridad Gestionada"
CYBERSEC_FUNDS_SUBSCRIPTION = "Ciberseguridad Gestionada Fondos"
CONNECT_SECURE_SUBSCRIPTION =  "Conexión Segura"
CONNECT_SECURE_FUNDS_SUBSCRIPTION = "Conexión Segura Fondos"
...
CYBERSEC_PRODUCTS = ["SEC_SMB_MANAGED_CYBERSEC"]
CYBERSEC_FUNDS_PRODUCTS = CYBERSEC_PRODUCTS + ["SEC_SMB_REC_FUNDS"]
CONNECT_SECURE_PRODUCTS =  ["SEC_SMB_SECURE_COMMS"]
CONNECT_SECURE_FUNDS_PRODUCTS = CONNECT_SECURE_PRODUCTS + ["SEC_SMB_REC_FUNDS"]
...
def get_subscription_type(item, exists_function):
    ...
    product_to_subscription = {
        tuple(CYBERSEC_PRODUCTS): CYBERSEC_SUBSCRIPTION,
        tuple(CYBERSEC_FUNDS_PRODUCTS): CYBERSEC_FUNDS_SUBSCRIPTION,
        tuple(CONNECT_SECURE_PRODUCTS): CONNECT_SECURE_SUBSCRIPTION,
        tuple(CONNECT_SECURE_FUNDS_PRODUCTS): CONNECT_SECURE_FUNDS_SUBSCRIPTION,
