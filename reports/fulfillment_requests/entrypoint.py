...
HEADERS = (
    ...
    'Email Domain', 'Branch Office Address', 'Sales Contact Email', 
    'Headquartes Id', 'Technical Contact Name', 'Technical Contact Email'
...
def _process_line(request, connection):
    return (
        ...
        get_value_from_array_by_id(request, 'asset.params', 'domain', 'value'),
        get_value_from_array_by_id(request, 'asset.params', 'postalAddress', 'value'),
        get_value_from_array_by_id(request, 'asset.params', 'salesTEemail', 'value'),
        get_value_from_array_by_id(request, 'asset.params', 'sede', 'value'),
        get_value_from_array_by_id(request, 'asset.params', 'technicalContact', 'value'),
        get_value_from_array_by_id(request, 'asset.params', 'technicalEmail', 'value'),
        get_value_from_array_by_id(request, 'asset.params', 'technicalPhone', 'value'),       
    )
