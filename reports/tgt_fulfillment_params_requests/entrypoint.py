...
FIELDS = Fields((
    ...
    Field('AntivirusLinuxSophos', lambda r: get_value_from_array_by_id(r, 'asset.params', 'AntivirusLinuxSophos', 'value')),
    Field('AntivirusMACSophos', lambda r: get_value_from_array_by_id(r, 'asset.params', 'AntivirusMACSophos', 'value')),
    Field('AntivirusWindowsSophos', lambda r: get_value_from_array_by_id(r, 'asset.params', 'AntivirusWindowsSophos', 'value')),
    Field('Antivirus_Provider', lambda r: get_value_from_array_by_id(r, 'asset.params', 'Antivirus_Provider', 'value')),
    Field('CrowdStrike_CID', lambda r: get_value_from_array_by_id(r, 'asset.params', 'CrowdStrike_CID', 'value')),
    Field('CrowdStrike_Customer-ID_with_Checksum_CCID', lambda r: get_value_from_array_by_id(r, 'asset.params', 'CrowdStrike_Customer-ID_with_Checksum_CCID', 'value')),
    Field('CrowdStrike_Host_Group_id', lambda r: get_value_from_array_by_id(r, 'asset.params', 'CrowdStrike_Host_Group_id', 'value')),
    ...
    Field('MDR_Provisioned', lambda r: get_value_from_array_by_id(r, 'asset.params', 'MDR_Provisioned', 'value')),
    Field('MDR_Technical_Contact_Name', lambda r: get_value_from_array_by_id(r, 'asset.params', 'MDR_Technical_Contact_Name', 'value')),
    Field('MDR_Technical_Contact_Phone', lambda r: get_value_from_array_by_id(r, 'asset.params', 'MDR_Technical_Contact_Phone', 'value')),
    Field('MDR_technical_contact_email', lambda r: get_value_from_array_by_id(r, 'asset.params', 'MDR_technical_contact_email', 'value')),
    Field('MobileConnectionCode', lambda r: get_value_from_array_by_id(r, 'asset.params', 'MobileConnectionCode', 'value')),
    Field('PhishThreat', lambda r: get_value_from_array_by_id(r, 'asset.params', 'PhishThreat', 'value')),
    Field('Sophos_Tenant_id', lambda r: get_value_from_array_by_id(r, 'asset.params', 'Sophos_Tenant_id', 'value')),
    ...
    Field('secondaryTechnicalContact', lambda r: get_value_from_array_by_id(r, 'asset.params', 'secondaryTechnicalContact', 'value')),
    Field('secondaryTechnicalEmail', lambda r: get_value_from_array_by_id(r, 'asset.params', 'secondaryTechnicalEmail', 'value')),
    Field('secondaryTechnicalPhone', lambda r: get_value_from_array_by_id(r, 'asset.params', 'secondaryTechnicalPhone', 'value')),
    Field('utm_port', lambda r: get_value_from_array_by_id(r, 'asset.params', 'utm_port', 'value')),
    Field('utm_provision_status', lambda r: get_value_from_array_by_id(r, 'asset.params', 'utm_provision_status', 'value')),
    Field('xdr_av_installation', lambda r: get_value_from_array_by_id(r, 'asset.params', 'xdr_av_installation', 'value')),
))
